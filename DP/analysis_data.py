...
def draw_diagram(dynamic_tree, insertion_deletion_instance, query_instance, ipp_instance, figure_file_name, query_length=1):
    members = query_instance.clique
    index_range = indexes = range(1, len(ipp_instance.get_segment()) - 1)
    for member in members:
        cur_range = query_instance.length_size[member][query_length]
        sum_1, sum_2, sum_3, sum_4 = {}, {}, {}, {}
        for index in index_range:
            sum_1_temp, sum_2_temp, sum_3_temp, sum_4_temp = 0, 0, 0, 0
            for i in range(cur_range):
                ...
                sum_4_temp += insertion_deletion_instance.answer_mechanism[member][index][i] * i
            ...
            sum_4[index] = sum_4_temp / sum(insertion_deletion_instance.answer_mechanism[member][index][0:cur_range])
        ...
        plt.legend(['ground truth', 'golden standard', 'mechanism', 'insertion only mechanism'], loc='upper left')
